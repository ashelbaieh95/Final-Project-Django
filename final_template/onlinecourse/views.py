...
def submit(request, course_id, lesson_id):
    ...
    return HttpResponseRedirect(
        reverse(viewname='onlinecourse:show_exam_result', args=(course.id, lesson.id, submission.id)))
...
def show_exam_result(request, course_id, lesson_id, submission_id):
    ...
    return render(request, 'onlinecourse/exam_result_bootstrap.html', model)